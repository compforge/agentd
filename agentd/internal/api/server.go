...
func (s *Server) Register(engine *route.Engine) {
	...
	engine.POST("/v1/agents/:agent_id", s.updateAgent)
	engine.POST("/v1/agents/:agent_id/archive", s.archiveAgent)
	engine.GET("/v1/agents/:agent_id/versions", s.listAgentVersions)
