...
func (noopSandbox) Stat(context.Context, string, string) (sandbox.FileInfo, error) {
	return sandbox.FileInfo{}, fs.ErrNotExist
}
func (noopSandbox) ReadFile(context.Context, string, string) ([]byte, error) {
	return nil, fs.ErrNotExist
}
func (noopSandbox) ReadDir(context.Context, string, string) ([]sandbox.DirEntry, error) {
	return nil, fs.ErrNotExist
}
...
func (noopSandbox) Execute(context.Context, string, sandbox.Command) (sandbox.CommandResult, error) {
	return sandbox.CommandResult{}, fmt.Errorf("noop sandbox does not execute commands")
}
